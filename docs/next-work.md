...
Already partially landed (keep issues open until acceptance fully met): #12 write queue, #18 allowlist handlers, #21 basic routes. Ingest upserts into the #13 `VectorStore`. MiniLM + LLM health landed in [PR #32](https://github.com/Anna-Hax/JUNO/pull/32). RAG `/search` landed in [PR #33](https://github.com/Anna-Hax/JUNO/pull/33).
