...
| RAG | `rag/engine.py` | Retrieve + sourced answers (from #17; Telegram query uses this) |
...
- Tests: `apps/core/tests/test_foundation.py`, `test_migrations.py`, `test_ingest.py`, `test_vectors.py`, `test_bot.py`
